...
var OUT = "D:/Documents/New project/probes/probe_psd_dialogue_layers.json";
...
function walk(container, rows, path) {
  for (var i = 0; i < container.layers.length; i++) {
    ...
    if (layer.name.indexOf("@PART1_DIALOGUE") >= 0 || itemPath.indexOf("@PART1_DIALOGUE") >= 0) {
      var row = {
        name: layer.name,
        path: itemPath,
